...
The implemented steps consist of calibration of the testing system, the setting up and performing procedures of strain-controlled test.
...
The accuracy of the force transducer shall meet the ASTM E4 and E467 requirements ($\pm 1\%$) during the tmf test duration.
...
The step of TMF test setting up consists of five parts: optimization of thermal stability, command/feedback phasing compensation, thermal strain compensation, thermal strain validation and preliminary measurements.


Through out the duration of the test, the specimen should be heated uniformly in the gauge section by the specified temperature command. 
