...
\begin{figure}
  ...
  (c) Half life stable hysteresis loops of In-Phase(OP) tests.
  (d) Peak, valley and mean stresses of In-Phase(OP) tests.
  (e) Half life stable hysteresis loops of 90$^{\circ}$C-Phase tests.
  (f) Peak, valley and mean stresses of 90$^{\circ}$C-Phase tests.}
