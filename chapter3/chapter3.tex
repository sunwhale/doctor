...
\begin{figure}[!htp]
  \centering
  \includegraphics[width=16cm]{plot_monotonic_tensile.pdf}
...
deviations between the upper/lower and middle monitor. It is concluded that the maximum axial temperature gradients during the TMF test is -10$^\circ$C to 15$^\circ$C.
