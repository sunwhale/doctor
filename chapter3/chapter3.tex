...
An water cooled axial/torsional extensometer (see \ref{Fig:extensometer}(b)) was used to measure the deformation in the gage section of the specimen at high temperature.
The extensometer can measure the axial strain and shear strain simultaneously without coupling effect.

The control loop feedback mechanism of the test rig is a proportional–integral–derivative controller (PID controller).
