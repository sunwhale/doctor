...
\begin{figure}
  ...
  \begin{minipage}[t]{0.5\linewidth}
    ...
    \end{overpic}
  \end{minipage}
  \caption{Microstructure of the investigated nickel-based superalloy Inconel 718 after solution treatment: (a) 200 times, (b) 1000 times.}
...
\end{overpic}
\caption{Dimensions of the specimens investigated in the study: (a) The solid specimen for uniaxial tests, (b) The tubular specimen for axial-torsional tests.}
\label{Fig:Specimen}
\end{figure}
...
\begin{figure}[!htp]
  \centering
  \includegraphics[width=12cm]{MTS809.pdf}
\caption{MTS model 809 axial torsional materials testing system with induction heating device.}
\label{Fig:MTS809}
\end{figure}

During the uniaxial tests, the strain within the gauge length of the specimen was measured using a high temperature axial extensometer (see \ref{Fig:extensometer}(a)).
...
\begin{figure}[!htp]
  \centering
    ...
    \end{overpic}
\caption{High temperature extensometers were used to measure the strain within the gauge length of the specimen. (a) Axial extensometer. (b) Axial/torsional extensometer.}
...
The extensometer can measure the axial and shear strain simultaneously without coupling effect.
...
It is found that the stability of the strain control loop was dependent on the mass flow of the cooling water.
The mass flow of the cooling water has to be less than 1.5l/min, otherwise the strain control loop will be instability.

Induction heating device was used for isothermal and thermomechanical fatigue tests.
...
Futhermore, the installation of the extensometer has to be considered.
...
\noindent
In this section, both uniaixal and axial-torsional isothermal fatigue tests are introduced.
\subsection{Introduction of axial-torsional fatigue testing}
\noindent
...
As shown in \ref{Fig:Shear_Strain}, $\phi$ is the angle of twist along the gage length of the cylindrical specimen, $\theta$ expressed in radians is the angle of twist between the planes defining the gage length of the cylindrical specimen.
$\theta$ is measurable directly as angle using specially calibrated torsional extensometers.
Thus, we have $\gamma = (d/2)\theta/ L_g$.

\begin{figure}[!htp]
  \centering
  \includegraphics[width=14cm]{shear_strain.pdf}
...
\subsection{Process of isothermal LCF tests}
\noindent
Both uniaxial and axial-torsional strain controlled isothermal low cycle fatigue (LCF) tests were performed with the induction heating device.
The temperature was measured by the thermocouples wrapped around the surface at the center of the gauge section of the specimen.
For the duration of each isothermal LCF test, the temperature deviations between the indicated and nominal values were less than $\pm$3K.
During uniaxial and axial-torsional LCF tests, the strain was measured by the axial extensometer (MTS Model 632.53) and the axial/torsional extensometer (MTS Model 632.68), respectively.
...
% The isothermal LCF experimental program consisted of axial, pure torsional and axial-torsional tests within the temperature range from 573K to 923K.
...
\subsection{Experimetnal results}
\noindent
...
\noindent
ISO 12111 and ASTM E2368\cite{ASTME2005} are the standard practices for thermo-mechanical fatigue tests under uniaxial strain-controlled conditions.
...
\begin{figure}[!htp]
  \centering
  \includegraphics[width=10.0cm]{temperature_monitors.pdf}
  \caption{caption.}
...
\begin{figure}[!htp]
  \centering
  \includegraphics[width=8.0cm]{plot_thermal_stability.pdf}
  \includegraphics[width=8.0cm]{plot_thermal_stability_deviation.pdf}
...
\begin{figure}[!htp]
  ...
  \end{overpic}
  \caption{Experimental results of the proportional thermomechanical fatigue tests with equivalent strain amplitudes $\Delta\varepsilon_{\rm eq}/2$= 0.6\%, 0.8\% and 1.0\%: (b)cyclic stress responses of the cycle at $N_{\rm f}/2$, (c)hallf-life hysteresis loops correspond to axial components, (d)peak, valley and mean values of shear stresses, (e)hallf-life hysteresis loops correspond to shear components, (f)peak, valley and mean values of shear stresses.
  }
...
\begin{figure}[!htp]
  ...
  \begin{overpic}[width=8.0cm]{plot_exp_pv_NPRIP_torsional.pdf}
    \put(84,13){\fcolorbox{white}{white}{(f)}}
  \end{overpic}
  \caption{TExperimental results of the non-proportional thermomechanical fatigue tests with equivalent strain amplitudes $\Delta\varepsilon_{\rm eq}/2$=0.5\%, 0.6\%, 0.7\%, 0.8\% and 1.0\%: (b)cyclic stress responses of the cycle at $N_{\rm f}/2$, (c)hallf-life hysteresis loops correspond to axial components, (d)peak, valley and mean values of shear stresses, (e)hallf-life hysteresis loops correspond to shear components, (f)peak, valley and mean values of shear stresses.}
