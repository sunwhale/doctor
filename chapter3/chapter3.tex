...
The investigated material is the nickel-base superalloy Inconel 718 in the form of rods of 20mm diameter, which was procured by Thyssen Krupp VDM GmbH.
...
The heating apparatus was the electric resistance furnace (MTS Model 653).
...
\begin{figure}[!htp]
\centering\scalebox{0.1}{\includegraphics{Furnace653_1.jpg}}
...
A triangular waveform was applied at a prescribed frequency of 0.05Hz over the strain range of $\pm 0.4\%$ to $\pm 1.0\%$.
...
All tests were stopped once 1,000,000 cycles had been reached.
Such tests are marked on graphs with a horizontal arrow.
All uniaxial fatigue tests were performed in total strain control by the MTS Multipurpose software (MPE).
...
\begin{figure}
  ...
  \begin{minipage}[t]{0.5\linewidth}
    ...
    \centerline{(b)}
  \end{minipage}
  \caption{In phase (IP) TMF tests of Inconel 718 with temperature range 350-600$^{\circ}$C. (a)Half life stable hysteresis loops. (b)Peak, valley and mean stresses.}
  \label{Fig:plot_exp_TCIP}
\end{figure}
...
图\ref{Fig:plot_exp_TCIP}和分别为合金在同相位和反相位试验条件下热机械
疲劳稳定滞后回线。在试验条件下,因为机械应变与温度是同相的,所以在机械应
变达到最大值最大拉应变时温度为最高温度℃,当机械应变为最小值最大压
应变时温度为最低温度℃。当机械应变幅小于时如图,。,,所示,
最大拉伸应力与最大拉伸应变同时出现在最高温度处,最大压缩应力,与最大压
缩应变同时出现在最低温度处。而在较大的机械应变幅■气`时图,
以循环第一周的滞后回线为例,最大拉伸应变与最大拉伸应力并不同步,最大拉伸应力
出现在机械应变幅约为时,此时的试验温度为℃,随着机械应变加载
到,拉伸应力开始下降,最高温度时的拉伸应力为。在试验条件下,
如图所示,由于温度与机械应变存在相位差“,所以在机械应变达到最大值最
大拉应变时温度为最低温度℃,当机械应变为最小值最大压应变时温度为最
高温度℃。当机械应变幅小于时,最大拉伸应力与最大压缩应力分别对应着
最大拉伸应变与最大压缩应变而当机械应变幅为时图,最大压缩应
