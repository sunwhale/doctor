...
\end{figure}
% From the calculated alternating stress-strain curve the same procedure for determining the material constants $\zeta^k$ and $r_0^k$ are used to determine the saturated values $r^k_s$ and $r^k_{\Delta \rm{s}}$.
