...
\begin{figure}[!htp]
\centering
\includegraphics[width=14cm]{plot_measurement_E.pdf}
...
\label{Equ:f_dec}
\end{equation}
where $\sigma_{\min}$ and $\sigma_{\max}$ are the minimum value for increasing stress part and the maximum value for decreasing stress part.
...
%\caption{Comparison between experiment at 300$^\circ$C under the cross loading path and computations by using different non-proportional hardening factors. The Mises stress is compared directly. (a) Without non-proportional hardening. (b) Non-proportional hardening factor = 200 MPa.}
...
%    \centerline{(b) Non-proportional hardening factor = 200 MPa.}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=14.0cm]{plot_cmp_mean_TCTMF.pdf}
...
%   \caption{Comparison between experiments at 300$^\circ$C under the cross loading path with computational predictions. (a) Without non-proportional hardening term. (b) With the non-proportional hardening factor $Y_{sat}$ = 200 MPa.}
%   \label{Fig:IN718_Isothermal_300C_7049_XPath_Exp_vs_Sim}
% \end{figure}
...
%    \centering
%    \includegraphics[width=3.5in]{IN718_Isothermal_300C_7049_XPath_Exp_vs_Sim_0.pdf}
%    \centerline{(a) ·?±èày???ˉ2?êyμèóú0 MPa.}
%    \label{Fig:IN718_Isothermal_300C_7049_XPath_Exp_vs_Sim_0}
%  \end{minipage}%
%  \begin{minipage}[t]{0.5\linewidth}
%    \centering
%    \includegraphics[width=3.5in]{IN718_Isothermal_300C_7049_XPath_Exp_vs_Sim_200.pdf}
%    \centerline{(b) ·?±èày???ˉ2?êyμèóú200 MPa.}
%    \label{Fig:IN718_Isothermal_300C_7049_XPath_Exp_vs_Sim_200}
%  \end{minipage}
