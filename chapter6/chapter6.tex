...
\subsection{Determination of $r_{\Delta s}^k$ from the cyclic stress-strain curves}
...
%%\caption{300$^{\circ}$CÊ±£¬XÐÍÂ·¾¶£¬ÊÔÑé½á¹ûÓë¼ÆËãÄ£ÄâµÄµÈÐ§Ó¦Á¦±È½Ï£¬·Ç±ÈÀýÇ¿»¯²ÎÊýµÈÓÚ0.}
%%\label{Fig:MisesStressWithoutNPHardening}
%%\end{figure}
%%
%%\begin{figure}[!htp]
%%\centering\scalebox{0.5}{\includegraphics{MisesStressWithNPHardening.pdf}}
%%\caption{300$^{\circ}$CÊ±£¬XÐÍÂ·¾¶£¬ÊÔÑé½á¹ûÓë¼ÆËãÄ£ÄâµÄµÈÐ§Ó¦Á¦±È½Ï£¬·Ç±ÈÀýÇ¿»¯²ÎÊýµÈÓÚ200.}
%%\label{Fig:MisesStressWithNPHardening}
%%\end{figure}
...
%    \centering
%    \includegraphics[width=3.5in]{IN718_Isothermal_300C_7049_XPath_Exp_vs_Sim_0.pdf}
%    \centerline{(a) ·Ç±ÈÀýÇ¿»¯²ÎÊýµÈÓÚ0MPa.}
%    \label{Fig:IN718_Isothermal_300C_7049_XPath_Exp_vs_Sim_0}
%  \end{minipage}%
%  \begin{minipage}[t]{0.5\linewidth}
%    \centering
%    \includegraphics[width=3.5in]{IN718_Isothermal_300C_7049_XPath_Exp_vs_Sim_200.pdf}
%    \centerline{(b) ·Ç±ÈÀýÇ¿»¯²ÎÊýµÈÓÚ200MPa.}
%    \label{Fig:IN718_Isothermal_300C_7049_XPath_Exp_vs_Sim_200}
%  \end{minipage}
%  \caption{300$^{\circ}$CÊ±£¬XÐÍÂ·¾¶£¬ÊÔÑé½á¹ûÓë¼ÆËãÄ£ÄâµÄÖáÏòÓ¦Á¦Óë¼ôÓ¦Á¦.}
%  \label{Fig:IN718_Isothermal_300C_7049_XPath_Exp_vs_Sim}
%\end{figure}
%
%\begin{figure}
...
%    \label{Fig:MisesStressWithNPHardening}
%  \end{minipage}
%  \caption{300$^{\circ}$CÊ±£¬XÐÍÂ·¾¶£¬ÊÔÑé½á¹ûÓë¼ÆËãÄ£ÄâµÄµÈÐ§Ó¦Á¦±È½Ï.}
%  \label{Fig:IN718_Isothermal_300C_7049_XPath_Exp_vs_Sim_MisesStress}
%\end{figure}
%
...
%  \end{minipage}
%  \caption{·´ÏàÎ»µÄÈÈ»úÆ£ÀÍÊÔÑéÓëÊýÖµÄ£Äâ£¬ÎÂ¶È300-650$^{\circ}$CÊ±.}
%  \label{Fig:TMF_OP}
%\end{figure}
%
%\begin{figure}
...
%  \end{minipage}
%  \caption{90$^{\circ}$ÏàÎ»µÄÈÈ»úÆ£ÀÍÊÔÑéÓëÊýÖµÄ£Äâ£¬ÎÂ¶È300-650$^{\circ}$CÊ±.}
%  \label{Fig:TMF_90}
%\end{figure}

\section{Summaries}
\noindent
In the section the multi-axial thermo-mechanical behavior of the nickel-based superalloy Inconel 718 has been investigated experimentally and computationally.
