...
As shown in \ref{Fig:E_G_PoissonsRatio}, the Young's modulus and shear modulus are observed to decrease with the increasing temperature.
However, the Poisson's ratio does not vary monotonically with temperature.
...
\begin{figure}[!htp]
\centering
\includegraphics[width=12cm]{plot_elastic_by_temperature_in718.pdf}
\caption{Young's modulus $E$, shear modulus $G$ and Poisson's Ratio at different temperatures.}
