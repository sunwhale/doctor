...
\end{equation}
\begin{figure}[!htp]
\centering\scalebox{0.8}{\includegraphics{radial_return_map_finite_strain.pdf}}
...
\end{equation}
\begin{figure}[!htp]
\centering\scalebox{0.7}{\includegraphics{successive_substitution_finite_strain.pdf}}
