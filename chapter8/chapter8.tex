...
\section{Experiments and simulations of the single lamp radiation in a cylindrical cavity}
\noindent
...
The material is stainless steel SS304 with a density of 7873kg/m$^3$, a specific heat of 502J/(kg$\cdot$K), and the 

The part is dimensioned in meters, and the temperature is measured in $^\circ$C, so the Stefan Boltzmann constant is taken as $5.670\times10^{-8}\rm{W}/(\rm{m}^{2}\cdot\rm{K})$ and absolute zero is set at 273.15°C below zero. The surface emissivity of gray iron is taken as a constant value of 0.77. 
