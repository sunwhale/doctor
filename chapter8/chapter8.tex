...
Due to the impact of cooling air, the accuracy of temperature measurement is not meet the requirements.
Therefore we tried to calculate the temperature distribution of the specimen inner surface using FEM method.
