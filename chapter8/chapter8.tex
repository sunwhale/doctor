...
The length of the gauge section of the specimen used in this study is 30cm, and the total length of the specimen is 120cm. Consequently, the double ended halogen lamps with a length of 115cm were chosen. According to the heat conduction equation, the temperature gradient of the material is proportional to the heat flux vector. In order achieve a large temperature gradient, a large heat flux is required. The developed radiant furnace consists of 16 halogen lamps, and the powers of the lamps can be chosen as 400W or 800W for different requirements of the TGMF tests.

In the present study, the lamp with the power of 400W was used. Thus, the radiant furnace has a power of 6.4kW. Typical test data for a nickel-based superalloy tubular specimen are: heating, from 23$^\circ$C to 1400$^\circ$C in about 50 seconds, cooling from 1400$^\circ$C to 100$^\circ$C in about 20 seconds, stationary, temperature gradient of 30$^\circ$C/mm.
...
\begin{table}[htbp]
  ...
  \caption{Add caption}
    ...
    \midrule
    Water cooling & Industrial water-cooling machine & 10kW, outlet water temperature from 10 to 18$^\circ$C \\
          & Cooling passage & fixtures and cooling passages in the radiation furnace \\
    \bottomrule
    \end{tabular}%
