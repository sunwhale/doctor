...
The filament can be simplified as a linear light source, due to its small diameter. As discussed above, if a linear light source is located at one focus of the elliptical cylinder mirror, the reflected light will pass through the other focus.
...
\begin{figure}
  \centering
  \begin{overpic}[width=8.0cm]{OneLightWithEllipseMirrorReflection.pdf}
    \put(84,65){\fcolorbox{white}{white}{(a)}}
  \end{overpic}
  \begin{overpic}[width=8.0cm]{one_lamp_reflection_1.png}
    \put(84,65){\fcolorbox{white}{white}{(b)}}
