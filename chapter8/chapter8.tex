...
% where $\bf{q}$ is the local heat flux density in the unit of W/m$^2$, $k$ is the material's conductivity in the unit of W/m$\cdot$K, $\nabla T$ is the temperature gradient in the unit of K/m.
...
\section{Analysis and design of a radiation heating system}
\noindent
...
Halogen lamps are used to heat the specimen.
...
%光源通常选取卤素灯。
The halogen lamp, also known as the quartz-halogen, is an incandescent lamp that has a small amount of a halogen such as iodine or bromine added.
...
\begin{enumerate}
\item Single lamp radiation test in a sealed cavity to determine the radiation efficiency of the single halogen lamp;
\item Elliptical cylinder mirror reflection test, to determine the reflection efficiency of the gold-plated mirror, and the convection heat transfer coefficient of the surface;
\item Heating test of the radiation furnace to verify the calculation results.
...
\subsection{Experimental and computational investigation of a single lamp radiation in the cylindrical cavity}
\noindent
...
\subsection{Experimental and computational investigation of a radiation heater with elliptical reflectors}
\noindent
...
\begin{figure}[!htp]
	...
	\caption{The specimen is heating by the radiation furnace.}
