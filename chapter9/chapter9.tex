...
As introduced in chapter 2, induction heating has the advantages of high heating rate and high efficiency and is widely used in TMF testing.
...
In the present study, the heating depth of the induced current is about 1-2mm, which means the inner and outer surfaces of the specimen is heated simultaneously.
in the internal cooling process, is not conducive to produce internal and external surface temperature gradient, while the electromagnetic induction method will only heat the internal metal layer, making the internal metal layer temperature is higher than the external ceramic layer temperature, which does not meet the thermal barrier coating Temperature distribution of layer members in actual working condition
