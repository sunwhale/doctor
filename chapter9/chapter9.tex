...
% \begin{figure}
%   \centering
%   \begin{overpic}[width=8.0cm]{plot_exp_mean_TCIPTGMF.pdf}
%     \put(84,65){\fcolorbox{white}{white}{(a)}}
%   \end{overpic}
%   \begin{overpic}[width=8.0cm]{plot_exp_mean_TCOPTGMF.pdf}
%     \put(84,65){\fcolorbox{white}{white}{(b)}}
%   \end{overpic}
...
\begin{figure}
   ...
   \end{overpic}
   \begin{overpic}[width=7.5cm]{NF-NP-TGMF-Zamrik.pdf}
...
\ref{Fig:TGMF_model} shows the life assessment of the TGMF tests. As shown in \ref{Fig:TGMF_model}(a), the fatigue damage parameters versus experimental fatigue lifetimes is illustrated. The fatigue damage parameters shows good correlation with experimental fatigue lifetimes of TGMF-IP and TGMF-OP tests. In \ref{Fig:TGMF_model}(b), one can observed that based on the proposed model (Equation (\ref{Equ:TGMF_model})), most of the predicted fatigue lifetimes are within the scatter band with a factor of 2. It shows a good agreement with the experimental and predicted fatigue lifetimes.
