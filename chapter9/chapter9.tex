...
\ref{Fig:plot_exp_fatigue_life_TMF_TGMF_TC} shows the comparison of the fatigue lifetimes of TMF and TGMF tests under in-phase and out-of-phase loading conditions, respectively.
The TC-IP-TGMF life is smaller than the TC-IP life as shown in \ref{Fig:plot_exp_fatigue_life_TMF_TGMF_TC}(a) and the TC-OP-TGMF life is smaller than the TC-OP life as shown in \ref{Fig:plot_exp_fatigue_life_TMF_TGMF_TC}(b).
...
Comparing \ref{Fig:plot_exp_fatigue_life_TMF_TGMF_TC}(a) with \ref{Fig:plot_exp_fatigue_life_TMF_TGMF_TC}(b), the reduction of TC-IP-TGMF life due to the temperature gradient is more evident than the reduction of TC-OP-TGMF life.
...
\begin{figure}[htbp]
  ...
  \caption{Diagram of simulated axial temperature gradients and the resulting, thermally induced axial stress components at maximum temprature (650$^{\circ}$C) during the TC-IP-TGMF test with the mechanical strain amplitude of 0.8\% (NT11: temperature in $^{\circ}$C, S22: axial stress in MPa, S33: hoop stress in MPa).}
...
The abscissa axis is the distance from the center section of the test specimen ($y$-axis in \ref{Fig:FE_model}). The temperature gradients induce an axial stress deviation of ca. 25 MPa between the inner and outer surface of the specimen.
...
The abscissa axis is the distance from the center axis to the outer surface of the test specimen ($r$-axis in \ref{Fig:FE_model}).
The temperature gradients induce a hoop stress deviation of ca. 50 MPa between the inner and outer surface of the specimen.
...
\begin{figure}[ht]
  \centering
    \begin{overpic}[width=8.0cm]{7206-2.jpg}
      ...
      \put(48,24){\color{white}\thicklines\circle{15}}
    ...
    \begin{overpic}[width=8.0cm]{730109.jpg}
      ...
      \put(48,34){\color{white}\thicklines\circle{15}}
    ...
    \begin{overpic}[width=8.0cm]{7207-103.jpg}
      ...
      \put(48,54){\color{white}\thicklines\circle{20}}
    ...
    \begin{overpic}[width=8.0cm]{7209-105.jpg}
      ...
      \put(38,30){\color{white}\thicklines\circle{30}}
      \put(68,30){\color{white}\thicklines\circle{30}}
...
\subsection{Fatigue life prediction based on the TGMF fatigue model}
\noindent
...
Table \ref{Tab:Temperature_gradient} lists the parameters in the calculation of the proposed TGMF model, where $\varphi$ is the angle of the critical plane, $T_{\sigma_{\rm n,\max}}$ is the maximum normal stress during the cycle on the critical plane, $T_{\sigma_{\rm n,\max}}$, $\partial T/\partial y$ and $\partial T/\partial r$ are the temperature and temperature gradients corresponding to the maximum normal stress location.
