...
% \begin{figure}
% \centering
% \includegraphics[width=14cm]{plot_values_with_angle_BM.pdf}
% \caption{Normal and shear strain range on various planes for Brown-Miller's Model.}
% \label{Fig:plot_values_with_angle_BM}
% \end{figure}

% \begin{figure}
% \centering
% \includegraphics[width=14cm]{plot_values_with_angle_FS.pdf}
% \caption{Shear strain range and maximum normal stress on various planes for Fatemi-Socie's Model.}
% \label{Fig:plot_values_with_angle_FS}
% \end{figure}

% \begin{figure}
% \centering
% \includegraphics[width=14cm]{plot_values_with_angle_SWT.pdf}
% \caption{Fatigue damage parameter of Smith-Watson-Topper's Model on various planes.}
% \label{Fig:plot_values_with_angle_SWT}
% \end{figure}

% \begin{figure}
% \centering
% \includegraphics[width=14cm]{plot_values_with_angle_Liu.pdf}
% \caption{Shear strain range and maximum normal stress on various planes for Liu's Model.}
% \label{Fig:plot_values_with_angle_Liu}
% \end{figure}
