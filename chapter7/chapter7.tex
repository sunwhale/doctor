...
Consider a material point $O$ which is the centre of the absolute coordinate $Oxyz$. As shown in \ref{Fig:generic_material_plane}, the orientation of a material plane $\Gamma$ having a normal unit vector ${\bf{n}}$ can be located by using spherical coordinates $\phi$ and $\theta$, where $\phi$ is the angle between the projection of unit vector ${\bf{n}}$ on $x–y$ plane and the $x$-axis, $\theta$ is the angle between the unit vector ${\bf{n}}$ and the $z$-axis. 
...
Comparison of \ref{Fig:coordinate_transformation_of_tensor}(c) and \ref{Fig:generic_material_plane}, the coordinate system ($x_1,x_2,x_3$) and ($x''_1,x''_2,x''_3$) can be considerded as the coordinate system ($x,y,z$) and ($n,a,b$) respectively. Considering a stress or strain state at the material point $O$, the components of stress and strain tensors in the coordinate system ($x,y,z$) are expressed as:
\begin{eqnarray}
...
and
\begin{eqnarray}
{\bf{\varepsilon }} = \left( {\begin{array}{*{20}{c}}
...
\begin{eqnarray}
{\bf{\sigma ''}} = \left( {\begin{array}{*{20}{c}}
{{\sigma _{{\rm{nn}}}}}&{{\tau _{{\rm{na}}}}}&{{\tau _{{\rm{nb}}}}}\\
{{\tau _{{\rm{an}}}}}&{{\sigma _{{\rm{aa}}}}}&{{\tau _{{\rm{ab}}}}}\\
{{\tau _{{\rm{bn}}}}}&{{\tau _{{\rm{ba}}}}}&{{\sigma _{{\rm{bb}}}}}
\end{array}} \right),
\end{eqnarray}
and
\begin{eqnarray}
{\bf{\varepsilon ''}} = \left( {\begin{array}{*{20}{c}}
{{\varepsilon _{{\rm{nn}}}}}&{{\varepsilon _{{\rm{na}}}}}&{{\varepsilon _{{\rm{nb}}}}}\\
{{\varepsilon _{{\rm{an}}}}}&{{\varepsilon _{{\rm{aa}}}}}&{{\varepsilon _{{\rm{ab}}}}}\\
{{\varepsilon _{{\rm{bn}}}}}&{{\varepsilon _{{\rm{ba}}}}}&{{\varepsilon _{{\rm{bb}}}}}
\end{array}} \right).
\end{eqnarray}
According to Equation (\ref{Equ:two_step_rotation}), we have:
\begin{equation}
{\bf{\sigma ''}} = {\bf{M\sigma }}{{\bf{M}}^{\rm{T}}},
\end{equation}
and
\begin{equation}
{\bf{\varepsilon ''}} = {\bf{M\varepsilon }}{{\bf{M}}^{\rm{T}}},
\end{equation}
