...
%In this chapter, mathematical and physical model are introduced.
...
\begin{figure}[!htp]
\centering\scalebox{0.6}{\includegraphics{YieldSurface2D.pdf}}
\caption{The von Mises and Tresca yield surfaces in principal stress coordinates.}
\label{Fig:YieldSurface3D}
\end{figure}

\begin{figure}[!htp]
\centering\scalebox{0.5}{\includegraphics{YieldSurface3D.pdf}}
\caption{The von Mises and Tresca yield surfaces in principal stress coordinates.}
